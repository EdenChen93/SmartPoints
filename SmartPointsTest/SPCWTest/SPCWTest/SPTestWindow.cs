...
namespace SPCWTest
{
    public partial class SPTestWindow : Form
    {
        ...
        private SPCwindowUI.SPCwindow Oringal_SpcW = new SPCwindow();
                ...
                else
                {
                    ...
                    switch (FileType)
                    {
                        case "mpdat":
                            ...
                            SPCTree.Nodes[0].Nodes.Add("SpcSize:" + Oringal_SpcW.pointsCloud.Width + '*' + Oringal_SpcW.pointsCloud.Height);
                            SPCTree.Nodes[0].Nodes.Add("ColorRange:" + Oringal_SpcW.pointsCloud.Zmin + ',' + Oringal_SpcW.pointsCloud.Zmax);
                            SPCTree.Nodes[0].Nodes.Add("Points:"); SPCTree.Nodes[0].Nodes[2].Name = "Points:";
                            SPCTree.Nodes[0].Nodes.Add("Lines:"); SPCTree.Nodes[0].Nodes[3].Name = "Lines:";
                            SPCTree.Nodes[0].Nodes.Add("Rects:"); SPCTree.Nodes[0].Nodes[4].Name = "Rects:";
                            SPCTree.Nodes[0].Nodes.Add("Circles:"); SPCTree.Nodes[0].Nodes[5].Name = "Circles:";
        ...
        private Rectangle I_RoiAreaLineChangeEvent(Rectangle rectangle)
        {
            ...
            SPCTree.Nodes[0].Nodes["Lines:"].Nodes[i].Text = rectangle.ToString();
            return rectangle;
