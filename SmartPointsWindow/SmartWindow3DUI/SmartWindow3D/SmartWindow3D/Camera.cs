...
namespace SmartWindow3D
{
    ...
    public class Camera
    {
        ...
        public Matrix4 GetModelMatrix(float z,float x,float y)
        {
            return Matrix4.Identity * Matrix4.CreateRotationZ((float)MathHelper.DegreesToRadians(z))* Matrix4.CreateRotationX((float)MathHelper.DegreesToRadians(x))* Matrix4.CreateRotationY((float)MathHelper.DegreesToRadians(y));
        }
